...
2. right clickon project folder and select open in integrated terminal 
 ![alt text](./image.png)
...
``` 
  ...
  ```
10. now you can start the server by typing
`npm run dev` in the terminal of project folder